...
export const formTypeAddImage = document.forms.formImg;
export const formEditProfile = document.forms.form;
export const popup = document.querySelector('.popup')
export const popups = document.querySelector('.popup_add');
export const popupBigImg = document.querySelector('.popup_big_img')
...
export const popupCloseGeneral = document.querySelector('.popup__close-icon_general')